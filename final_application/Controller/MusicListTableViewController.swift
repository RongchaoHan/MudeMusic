...
class MusicListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        content.text = musics[indexPath.row].name
        content.textProperties.font = UIFont.preferredFont(forTextStyle: .title2)
        
        content.secondaryText = musics[indexPath.row].artist
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        currentMusic = musics[indexPath.row]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "MusicPlayerSegue"{
            ...
            destination.musics = self.musics
            destination.currentMusic = self.currentMusic
        }
    }
